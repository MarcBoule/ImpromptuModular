...
* **Squash overlap**: This slider determines how much overlap is applied between octaves as the squash knob is turned up. With 100% squash, all ranges except the center one are controlled in tandem, whereas at 0% overlap, the squash knob will gradually reduce each range consecutively.
